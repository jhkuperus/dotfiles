...
#
# Note: this file was originally downloaded from the website of
# iTerm2 (https://iterm2.com/shell_integration/zsh). It is stored
# in this repository for my own personal backup. 
