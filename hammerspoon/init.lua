...
for key, value in pairs(appSwitcherKeys) do
	if type(value) ~= "table" then
		hyper.bindKey(key, createActionFunctionForAppSwitcher(value))
	else
		if value["shift"] ~= nil then
			hyper.bindShiftKey(key, createActionFunctionForAppSwitcher(value["shift"]))
		end
...
hyper.bindShiftKey("down", function()
