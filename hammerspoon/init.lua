...
hyper.bindShiftKey('m', function() am.switchToAndFromApp("com.postbox-inc.postbox") end)
...
hyper.bindKey(']', function() am.switchToAndFromApp("com.github.wez.wezterm") end)
-- hyper.bindKey(']', function() am.switchToAndFromApp("org.alacritty") end)
hyper.bindKey('[', function() am.switchToAndFromApp("com.apple.ActivityMonitor") end)
hyper.bindKey(';', function() am.switchToAndFromApp("org.mozilla.firefox") end)
hyper.bindShiftKey(';', function() am.switchToAndFromApp("com.google.Chrome") end)
...
hyper.bindShiftKey('l', function() am.switchToAndFromApp("com.jetbrains.intellij-EAP") end)
...
hyper.bindKey('=', function() am.switchToAndFromApp("com.binance.mac-client") end)
